    ...
    return {
        ...
        apiAbilityScoresIndexGet(index: string, options: any = {}): FetchArgs {
            ...
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiAbilityScoresIndexGet.');
            }
            const localVarPath = `/api/ability-scores/{index}`
        ...
        apiAlignmentsIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiAlignmentsIndexGet.');
            }
            const localVarPath = `/api/alignments/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        apiBackgroundsIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiBackgroundsIndexGet.');
            }
            const localVarPath = `/api/backgrounds/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        apiLanguagesIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiLanguagesIndexGet.');
            }
            const localVarPath = `/api/languages/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        apiProficienciesIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiProficienciesIndexGet.');
            }
            const localVarPath = `/api/proficiencies/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        apiSkillsIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiSkillsIndexGet.');
            }
            const localVarPath = `/api/skills/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
...
export const CharacterDataApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiAbilityScoresIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<AbilityScore> {
            const localVarFetchArgs = CharacterDataApiFetchParamCreator(configuration).apiAbilityScoresIndexGet(index, options);
         ...
         * @throws {RequiredError}
         */
        apiAlignmentsIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Alignment> {
            const localVarFetchArgs = CharacterDataApiFetchParamCreator(configuration).apiAlignmentsIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiBackgroundsIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Background> {
            const localVarFetchArgs = CharacterDataApiFetchParamCreator(configuration).apiBackgroundsIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiLanguagesIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Language> {
            const localVarFetchArgs = CharacterDataApiFetchParamCreator(configuration).apiLanguagesIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiProficienciesIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Proficiency> {
            const localVarFetchArgs = CharacterDataApiFetchParamCreator(configuration).apiProficienciesIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiSkillsIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Skill> {
            const localVarFetchArgs = CharacterDataApiFetchParamCreator(configuration).apiSkillsIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const CharacterDataApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * # Ability Score  Represents one of the six abilities that describes a creature's physical and mental characteristics. The three main rolls of the game - the ability check, the saving throw, and the attack roll - rely on the ability scores. [[SRD p76](https://media.wizards.com/2016/downloads/DND/SRD-OGL_V5.1.pdf#page=76)] 
         * @summary Get an ability score by index.
        ...
        apiAbilityScoresIndexGet(index: string, options?: any) {
            return CharacterDataApiFp(configuration).apiAbilityScoresIndexGet(index, options)(fetch, basePath);
        },
        /**
         * # Alignment  A typical creature in the game world has an alignment, which broadly describes its moral and personal attitudes. Alignment is a combination of two factors: one identifies morality (good, evil, or neutral), and the other describes attitudes toward society and order (lawful, chaotic, or neutral). Thus, nine distinct alignments define the possible combinations.[[SRD p58](https://media.wizards.com/2016/downloads/DND/SRD-OGL_V5.1.pdf#page=58)] 
         * @summary Get an alignment by index.
        ...
        apiAlignmentsIndexGet(index: string, options?: any) {
            return CharacterDataApiFp(configuration).apiAlignmentsIndexGet(index, options)(fetch, basePath);
        },
        /**
         * # Background  Every story has a beginning. Your character's background reveals where you came from, how you became an adventurer, and your place in the world. Choosing a background provides you with important story cues about your character's identity. [[SRD p60](https://media.wizards.com/2016/downloads/DND/SRD-OGL_V5.1.pdf#page=60)]  _Note:_ acolyte is the only background included in the SRD. 
         * @summary Get a background by index.
        ...
        apiBackgroundsIndexGet(index: string, options?: any) {
            return CharacterDataApiFp(configuration).apiBackgroundsIndexGet(index, options)(fetch, basePath);
        },
        /**
         * # Language  Your race indicates the languages your character can speak by default, and your background might give you access to one or more additional languages of your choice. [[SRD p59](https://media.wizards.com/2016/downloads/DND/SRD-OGL_V5.1.pdf#page=59)] 
         * @summary Get a language by index.
        ...
        apiLanguagesIndexGet(index: string, options?: any) {
            return CharacterDataApiFp(configuration).apiLanguagesIndexGet(index, options)(fetch, basePath);
        },
        /**
         * # Proficiency   By virtue of race, class, and background a character is proficient at using certain skills, weapons, and equipment. Characters can also gain additional proficiencies at higher levels or by multiclassing. A characters starting proficiencies are determined during character creation. 
         * @summary Get a proficiency by index.
        ...
        apiProficienciesIndexGet(index: string, options?: any) {
            return CharacterDataApiFp(configuration).apiProficienciesIndexGet(index, options)(fetch, basePath);
        },
        /**
         * # Skill  Each ability covers a broad range of capabilities, including skills that a character or a monster can be proficient in. A skill represents a specific aspect of an ability score, and an individual's proficiency in a skill demonstrates a focus on that aspect. [[SRD p77](https://media.wizards.com/2016/downloads/DND/SRD-OGL_V5.1.pdf#page=77)] 
         * @summary Get a skill by index.
...
export class CharacterDataApi extends BaseAPI {
    ...
    public apiAbilityScoresIndexGet(index: string, options?: any) {
        return CharacterDataApiFp(this.configuration).apiAbilityScoresIndexGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiAlignmentsIndexGet(index: string, options?: any) {
        return CharacterDataApiFp(this.configuration).apiAlignmentsIndexGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiBackgroundsIndexGet(index: string, options?: any) {
        return CharacterDataApiFp(this.configuration).apiBackgroundsIndexGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiLanguagesIndexGet(index: string, options?: any) {
        return CharacterDataApiFp(this.configuration).apiLanguagesIndexGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiProficienciesIndexGet(index: string, options?: any) {
        return CharacterDataApiFp(this.configuration).apiProficienciesIndexGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiSkillsIndexGet(index: string, options?: any) {
        return CharacterDataApiFp(this.configuration).apiSkillsIndexGet(index, options)(this.fetch, this.basePath);
    }
...
export const ClassApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        apiClassesIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiClassesIndexGet.');
            }
            const localVarPath = `/api/classes/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        apiClassesIndexMultiClassingGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiClassesIndexMultiClassingGet.');
            }
            const localVarPath = `/api/classes/{index}/multi-classing`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        apiClassesIndexSpellcastingGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiClassesIndexSpellcastingGet.');
            }
            const localVarPath = `/api/classes/{index}/spellcasting`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
...
export const ClassApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiClassesIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ModelClass> {
            const localVarFetchArgs = ClassApiFetchParamCreator(configuration).apiClassesIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiClassesIndexMultiClassingGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Multiclassing> {
            const localVarFetchArgs = ClassApiFetchParamCreator(configuration).apiClassesIndexMultiClassingGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiClassesIndexSpellcastingGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Spellcasting> {
            const localVarFetchArgs = ClassApiFetchParamCreator(configuration).apiClassesIndexSpellcastingGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const ClassApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * # Class  A character class is a fundamental part of the identity and nature of characters in the Dungeons & Dragons role-playing game. A character's capabilities, strengths, and weaknesses are largely defined by its class. A character's class affects a character's available skills and abilities. [[SRD p8-55](https://media.wizards.com/2016/downloads/DND/SRD-OGL_V5.1.pdf#page=8)] 
         * @summary Get a class by index.
        ...
        apiClassesIndexMultiClassingGet(index: string, options?: any) {
            return ClassApiFp(configuration).apiClassesIndexMultiClassingGet(index, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get spellcasting info for a class.
        ...
        apiClassesIndexSpellcastingGet(index: string, options?: any) {
            return ClassApiFp(configuration).apiClassesIndexSpellcastingGet(index, options)(fetch, basePath);
        },
    };
};
...
export class ClassApi extends BaseAPI {
    ...
    public apiClassesIndexGet(index: string, options?: any) {
        return ClassApiFp(this.configuration).apiClassesIndexGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiClassesIndexMultiClassingGet(index: string, options?: any) {
        return ClassApiFp(this.configuration).apiClassesIndexMultiClassingGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiClassesIndexSpellcastingGet(index: string, options?: any) {
        return ClassApiFp(this.configuration).apiClassesIndexSpellcastingGet(index, options)(this.fetch, this.basePath);
    }
...
export const ClassLevelsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiClassesIndexLevelsClassLevelFeaturesGet(index: string, classLevel: number, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiClassesIndexLevelsClassLevelFeaturesGet.');
            }
            // verify required parameter 'classLevel' is not null or undefined
            if (classLevel === null || classLevel === undefined) {
                throw new RequiredError('classLevel','Required parameter classLevel was null or undefined when calling apiClassesIndexLevelsClassLevelFeaturesGet.');
            }
         ...
         * @throws {RequiredError}
         */
        apiClassesIndexLevelsClassLevelGet(index: string, classLevel: number, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiClassesIndexLevelsClassLevelGet.');
            }
            // verify required parameter 'classLevel' is not null or undefined
            if (classLevel === null || classLevel === undefined) {
                throw new RequiredError('classLevel','Required parameter classLevel was null or undefined when calling apiClassesIndexLevelsClassLevelGet.');
            }
        ...
        apiClassesIndexLevelsGet(index: string, subclass?: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiClassesIndexLevelsGet.');
            }
            const localVarPath = `/api/classes/{index}/levels`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
         ...
         * @throws {RequiredError}
         */
        apiClassesIndexLevelsSpellLevelSpellsGet(index: string, spellLevel: number, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiClassesIndexLevelsSpellLevelSpellsGet.');
            }
            // verify required parameter 'spellLevel' is not null or undefined
            if (spellLevel === null || spellLevel === undefined) {
                throw new RequiredError('spellLevel','Required parameter spellLevel was null or undefined when calling apiClassesIndexLevelsSpellLevelSpellsGet.');
            }
...
export const ClassLevelsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiClassesIndexLevelsClassLevelFeaturesGet(index: string, classLevel: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<APIReferenceList> {
            const localVarFetchArgs = ClassLevelsApiFetchParamCreator(configuration).apiClassesIndexLevelsClassLevelFeaturesGet(index, classLevel, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiClassesIndexLevelsClassLevelGet(index: string, classLevel: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ClassLevel> {
            const localVarFetchArgs = ClassLevelsApiFetchParamCreator(configuration).apiClassesIndexLevelsClassLevelGet(index, classLevel, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiClassesIndexLevelsGet(index: string, subclass?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<ClassLevel>> {
            const localVarFetchArgs = ClassLevelsApiFetchParamCreator(configuration).apiClassesIndexLevelsGet(index, subclass, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiClassesIndexLevelsSpellLevelSpellsGet(index: string, spellLevel: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<APIReferenceList> {
            const localVarFetchArgs = ClassLevelsApiFetchParamCreator(configuration).apiClassesIndexLevelsSpellLevelSpellsGet(index, spellLevel, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const ClassLevelsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * 
         * @summary Get features available to a class at the requested level.
        ...
        apiClassesIndexLevelsClassLevelFeaturesGet(index: string, classLevel: number, options?: any) {
            return ClassLevelsApiFp(configuration).apiClassesIndexLevelsClassLevelFeaturesGet(index, classLevel, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get level resource for a class and level.
        ...
        apiClassesIndexLevelsClassLevelGet(index: string, classLevel: number, options?: any) {
            return ClassLevelsApiFp(configuration).apiClassesIndexLevelsClassLevelGet(index, classLevel, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get all level resources for a class.
        ...
        apiClassesIndexLevelsGet(index: string, subclass?: string, options?: any) {
            return ClassLevelsApiFp(configuration).apiClassesIndexLevelsGet(index, subclass, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get spells of the requested level available to the class.
        ...
        apiClassesIndexLevelsSpellLevelSpellsGet(index: string, spellLevel: number, options?: any) {
            return ClassLevelsApiFp(configuration).apiClassesIndexLevelsSpellLevelSpellsGet(index, spellLevel, options)(fetch, basePath);
        },
    };
};
...
export class ClassLevelsApi extends BaseAPI {
     ...
     */
    public apiClassesIndexLevelsClassLevelFeaturesGet(index: string, classLevel: number, options?: any) {
        return ClassLevelsApiFp(this.configuration).apiClassesIndexLevelsClassLevelFeaturesGet(index, classLevel, options)(this.fetch, this.basePath);
    }
    ...
    public apiClassesIndexLevelsClassLevelGet(index: string, classLevel: number, options?: any) {
        return ClassLevelsApiFp(this.configuration).apiClassesIndexLevelsClassLevelGet(index, classLevel, options)(this.fetch, this.basePath);
    }
    ...
    public apiClassesIndexLevelsGet(index: string, subclass?: string, options?: any) {
        return ClassLevelsApiFp(this.configuration).apiClassesIndexLevelsGet(index, subclass, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ClassLevelsApi
     */
    public apiClassesIndexLevelsSpellLevelSpellsGet(index: string, spellLevel: number, options?: any) {
        return ClassLevelsApiFp(this.configuration).apiClassesIndexLevelsSpellLevelSpellsGet(index, spellLevel, options)(this.fetch, this.basePath);
    }
...
export const ClassResourceListsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        apiClassesIndexFeaturesGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiClassesIndexFeaturesGet.');
            }
            const localVarPath = `/api/classes/{index}/features`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        apiClassesIndexProficienciesGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiClassesIndexProficienciesGet.');
            }
            const localVarPath = `/api/classes/{index}/proficiencies`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        apiClassesIndexSpellsGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiClassesIndexSpellsGet.');
            }
            const localVarPath = `/api/classes/{index}/spells`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        apiClassesIndexSubclassesGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiClassesIndexSubclassesGet.');
            }
            const localVarPath = `/api/classes/{index}/subclasses`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
...
export const ClassResourceListsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiClassesIndexFeaturesGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<APIReferenceList> {
            const localVarFetchArgs = ClassResourceListsApiFetchParamCreator(configuration).apiClassesIndexFeaturesGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiClassesIndexProficienciesGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<APIReferenceList> {
            const localVarFetchArgs = ClassResourceListsApiFetchParamCreator(configuration).apiClassesIndexProficienciesGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiClassesIndexSpellsGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<APIReferenceList> {
            const localVarFetchArgs = ClassResourceListsApiFetchParamCreator(configuration).apiClassesIndexSpellsGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiClassesIndexSubclassesGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<APIReferenceList> {
            const localVarFetchArgs = ClassResourceListsApiFetchParamCreator(configuration).apiClassesIndexSubclassesGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const ClassResourceListsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * 
         * @summary Get features available for a class.
        ...
        apiClassesIndexFeaturesGet(index: string, options?: any) {
            return ClassResourceListsApiFp(configuration).apiClassesIndexFeaturesGet(index, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get proficiencies available for a class.
        ...
        apiClassesIndexProficienciesGet(index: string, options?: any) {
            return ClassResourceListsApiFp(configuration).apiClassesIndexProficienciesGet(index, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get spells available for a class.
        ...
        apiClassesIndexSpellsGet(index: string, options?: any) {
            return ClassResourceListsApiFp(configuration).apiClassesIndexSpellsGet(index, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get subclasses available for a class.
        ...
        apiClassesIndexSubclassesGet(index: string, options?: any) {
            return ClassResourceListsApiFp(configuration).apiClassesIndexSubclassesGet(index, options)(fetch, basePath);
        },
    };
};
...
export class ClassResourceListsApi extends BaseAPI {
    ...
    public apiClassesIndexFeaturesGet(index: string, options?: any) {
        return ClassResourceListsApiFp(this.configuration).apiClassesIndexFeaturesGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiClassesIndexProficienciesGet(index: string, options?: any) {
        return ClassResourceListsApiFp(this.configuration).apiClassesIndexProficienciesGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiClassesIndexSpellsGet(index: string, options?: any) {
        return ClassResourceListsApiFp(this.configuration).apiClassesIndexSpellsGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiClassesIndexSubclassesGet(index: string, options?: any) {
        return ClassResourceListsApiFp(this.configuration).apiClassesIndexSubclassesGet(index, options)(this.fetch, this.basePath);
    }
    ...
    return {
        ...
        apiEndpointGet(endpoint: string, options: any = {}): FetchArgs {
            ...
            if (endpoint === null || endpoint === undefined) {
                throw new RequiredError('endpoint','Required parameter endpoint was null or undefined when calling apiEndpointGet.');
            }
...
export const CommonApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiEndpointGet(endpoint: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<APIReferenceList> {
            const localVarFetchArgs = CommonApiFetchParamCreator(configuration).apiEndpointGet(endpoint, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiGet(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<{ [key: string]: string; }> {
...
export class CommonApi extends BaseAPI {
    ...
    public apiEndpointGet(endpoint: string, options?: any) {
        return CommonApiFp(this.configuration).apiEndpointGet(endpoint, options)(this.fetch, this.basePath);
    }
...
export const EquipmentApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        apiEquipmentCategoriesIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiEquipmentCategoriesIndexGet.');
            }
            const localVarPath = `/api/equipment-categories/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        apiEquipmentIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiEquipmentIndexGet.');
            }
            const localVarPath = `/api/equipment/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        apiMagicItemsIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiMagicItemsIndexGet.');
            }
            const localVarPath = `/api/magic-items/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        apiWeaponPropertiesIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiWeaponPropertiesIndexGet.');
            }
            const localVarPath = `/api/weapon-properties/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
...
export const EquipmentApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiEquipmentCategoriesIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<EquipmentCategory> {
            const localVarFetchArgs = EquipmentApiFetchParamCreator(configuration).apiEquipmentCategoriesIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiEquipmentIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Equipment> {
            const localVarFetchArgs = EquipmentApiFetchParamCreator(configuration).apiEquipmentIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiMagicItemsIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<MagicItem> {
            const localVarFetchArgs = EquipmentApiFetchParamCreator(configuration).apiMagicItemsIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiWeaponPropertiesIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<WeaponProperty> {
            const localVarFetchArgs = EquipmentApiFetchParamCreator(configuration).apiWeaponPropertiesIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const EquipmentApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * These are the categories that various equipment fall under.
         * @summary Get an equipment category by index.
        ...
        apiEquipmentCategoriesIndexGet(index: string, options?: any) {
            return EquipmentApiFp(configuration).apiEquipmentCategoriesIndexGet(index, options)(fetch, basePath);
        },
        /**
         * # Equipment  Opportunities abound to find treasure, equipment, weapons, armor, and more  in the dungeons you explore. Normally, you can sell your treasures and  trinkets when you return to a town or other settlement, provided that you  can find buyers and merchants interested in your loot. 
         * @summary Get an equipment item by index.
        ...
        apiWeaponPropertiesIndexGet(index: string, options?: any) {
            return EquipmentApiFp(configuration).apiWeaponPropertiesIndexGet(index, options)(fetch, basePath);
        },
    };
};
...
export class EquipmentApi extends BaseAPI {
    ...
    public apiEquipmentCategoriesIndexGet(index: string, options?: any) {
        return EquipmentApiFp(this.configuration).apiEquipmentCategoriesIndexGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiEquipmentIndexGet(index: string, options?: any) {
        return EquipmentApiFp(this.configuration).apiEquipmentIndexGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiMagicItemsIndexGet(index: string, options?: any) {
        return EquipmentApiFp(this.configuration).apiMagicItemsIndexGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiWeaponPropertiesIndexGet(index: string, options?: any) {
        return EquipmentApiFp(this.configuration).apiWeaponPropertiesIndexGet(index, options)(this.fetch, this.basePath);
    }
...
export const FeatsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        apiFeatsIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiFeatsIndexGet.');
            }
            const localVarPath = `/api/feats/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
...
export const FeatsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiFeatsIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Feat> {
            const localVarFetchArgs = FeatsApiFetchParamCreator(configuration).apiFeatsIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const FeatsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * # Feat   A feat is a boon a character can receive at level up instead of an ability score increase. 
         * @summary Get a feat by index.
...
export class FeatsApi extends BaseAPI {
    ...
    public apiFeatsIndexGet(index: string, options?: any) {
        return FeatsApiFp(this.configuration).apiFeatsIndexGet(index, options)(this.fetch, this.basePath);
    }
...
export const FeaturesApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        apiFeaturesIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiFeaturesIndexGet.');
            }
            const localVarPath = `/api/features/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
...
export const FeaturesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiFeaturesIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Feature> {
            const localVarFetchArgs = FeaturesApiFetchParamCreator(configuration).apiFeaturesIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const FeaturesApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * # Feature   When you gain a new level in a class, you get its features for that level.  You don’t, however, receive the class’s starting Equipment, and a few  features have additional rules when you’re multiclassing: Channel Divinity,  Extra Attack, Unarmored Defense, and Spellcasting. 
         * @summary Get a feature by index.
...
export class FeaturesApi extends BaseAPI {
    ...
    public apiFeaturesIndexGet(index: string, options?: any) {
        return FeaturesApiFp(this.configuration).apiFeaturesIndexGet(index, options)(this.fetch, this.basePath);
    }
...
export const GameMechanicsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        apiConditionsIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiConditionsIndexGet.');
            }
            const localVarPath = `/api/conditions/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        apiDamageTypesIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiDamageTypesIndexGet.');
            }
            const localVarPath = `/api/damage-types/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        apiMagicSchoolsIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiMagicSchoolsIndexGet.');
            }
            const localVarPath = `/api/magic-schools/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
...
export const GameMechanicsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiConditionsIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Condition> {
            const localVarFetchArgs = GameMechanicsApiFetchParamCreator(configuration).apiConditionsIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiDamageTypesIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<DamageType> {
            const localVarFetchArgs = GameMechanicsApiFetchParamCreator(configuration).apiDamageTypesIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiMagicSchoolsIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<MagicSchool> {
            const localVarFetchArgs = GameMechanicsApiFetchParamCreator(configuration).apiMagicSchoolsIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const GameMechanicsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * # Condition  A condition alters a creature’s capabilities in a variety of ways and can  arise as a result of a spell, a class feature, a monster’s attack, or other  effect. Most conditions, such as blinded, are impairments, but a few, such  as invisible, can be advantageous. 
         * @summary Get a condition by index.
        ...
        apiConditionsIndexGet(index: string, options?: any) {
            return GameMechanicsApiFp(configuration).apiConditionsIndexGet(index, options)(fetch, basePath);
        },
        /**
         * # Damage type  Different attacks, damaging spells, and other harmful effects deal different  types of damage. Damage types have no rules of their own, but other rules,  such as damage resistance, rely on the types. 
         * @summary Get a damage type by index.
        ...
        apiDamageTypesIndexGet(index: string, options?: any) {
            return GameMechanicsApiFp(configuration).apiDamageTypesIndexGet(index, options)(fetch, basePath);
        },
        /**
         * # Magic School  Academies of magic group spells into eight categories called schools of  magic. Scholars, particularly wizards, apply these categories to all spells,  believing that all magic functions in essentially the same way, whether it  derives from rigorous study or is bestowed by a deity. 
         * @summary Get a magic school by index.
        ...
        apiMagicSchoolsIndexGet(index: string, options?: any) {
            return GameMechanicsApiFp(configuration).apiMagicSchoolsIndexGet(index, options)(fetch, basePath);
        },
    };
};
...
export class GameMechanicsApi extends BaseAPI {
    ...
    public apiConditionsIndexGet(index: string, options?: any) {
        return GameMechanicsApiFp(this.configuration).apiConditionsIndexGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiDamageTypesIndexGet(index: string, options?: any) {
        return GameMechanicsApiFp(this.configuration).apiDamageTypesIndexGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiMagicSchoolsIndexGet(index: string, options?: any) {
        return GameMechanicsApiFp(this.configuration).apiMagicSchoolsIndexGet(index, options)(this.fetch, this.basePath);
    }
...
export const MonstersApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        apiMonstersIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiMonstersIndexGet.');
            }
            const localVarPath = `/api/monsters/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
...
export const MonstersApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiMonstersGet(challengeRating?: Array<number>, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<APIReferenceList> {
            const localVarFetchArgs = MonstersApiFetchParamCreator(configuration).apiMonstersGet(challengeRating, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiMonstersIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Monster> {
            const localVarFetchArgs = MonstersApiFetchParamCreator(configuration).apiMonstersIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const MonstersApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * 
         * @summary Get list of monsters with optional filtering
...
export class MonstersApi extends BaseAPI {
    ...
    public apiMonstersGet(challengeRating?: Array<number>, options?: any) {
        return MonstersApiFp(this.configuration).apiMonstersGet(challengeRating, options)(this.fetch, this.basePath);
    }
    ...
    public apiMonstersIndexGet(index: string, options?: any) {
        return MonstersApiFp(this.configuration).apiMonstersIndexGet(index, options)(this.fetch, this.basePath);
    }
...
export const RacesApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        apiRacesIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiRacesIndexGet.');
            }
            const localVarPath = `/api/races/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        apiRacesIndexProficienciesGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiRacesIndexProficienciesGet.');
            }
            const localVarPath = `/api/races/{index}/proficiencies`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        apiRacesIndexSubracesGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiRacesIndexSubracesGet.');
            }
            const localVarPath = `/api/races/{index}/subraces`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        apiRacesIndexTraitsGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiRacesIndexTraitsGet.');
            }
            const localVarPath = `/api/races/{index}/traits`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
...
export const RacesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiRacesIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Race> {
            const localVarFetchArgs = RacesApiFetchParamCreator(configuration).apiRacesIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiRacesIndexProficienciesGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<APIReferenceList> {
            const localVarFetchArgs = RacesApiFetchParamCreator(configuration).apiRacesIndexProficienciesGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiRacesIndexSubracesGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<APIReferenceList> {
            const localVarFetchArgs = RacesApiFetchParamCreator(configuration).apiRacesIndexSubracesGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiRacesIndexTraitsGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<APIReferenceList> {
            const localVarFetchArgs = RacesApiFetchParamCreator(configuration).apiRacesIndexTraitsGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const RacesApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * Each race grants your character ability and skill bonuses as well as racial traits.
         * @summary Get a race by index.
        ...
        apiRacesIndexProficienciesGet(index: string, options?: any) {
            return RacesApiFp(configuration).apiRacesIndexProficienciesGet(index, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get subraces available for a race.
...
export class RacesApi extends BaseAPI {
    ...
    public apiRacesIndexGet(index: string, options?: any) {
        return RacesApiFp(this.configuration).apiRacesIndexGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiRacesIndexProficienciesGet(index: string, options?: any) {
        return RacesApiFp(this.configuration).apiRacesIndexProficienciesGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiRacesIndexSubracesGet(index: string, options?: any) {
        return RacesApiFp(this.configuration).apiRacesIndexSubracesGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiRacesIndexTraitsGet(index: string, options?: any) {
        return RacesApiFp(this.configuration).apiRacesIndexTraitsGet(index, options)(this.fetch, this.basePath);
    }
...
export const RulesApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        apiRuleSectionsIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiRuleSectionsIndexGet.');
            }
            const localVarPath = `/api/rule-sections/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        apiRulesIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiRulesIndexGet.');
            }
            const localVarPath = `/api/rules/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
...
export const RulesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiRuleSectionsIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<RuleSection> {
            const localVarFetchArgs = RulesApiFetchParamCreator(configuration).apiRuleSectionsIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiRulesIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Rule> {
            const localVarFetchArgs = RulesApiFetchParamCreator(configuration).apiRulesIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const RulesApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * Rule sections represent a sub-heading and text that can be found underneath a rule heading in the SRD.
         * @summary Get a rule section by index.
...
export class RulesApi extends BaseAPI {
    ...
    public apiRuleSectionsIndexGet(index: string, options?: any) {
        return RulesApiFp(this.configuration).apiRuleSectionsIndexGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiRulesIndexGet(index: string, options?: any) {
        return RulesApiFp(this.configuration).apiRulesIndexGet(index, options)(this.fetch, this.basePath);
    }
...
export const SpellsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        apiSpellsIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiSpellsIndexGet.');
            }
            const localVarPath = `/api/spells/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
...
export const SpellsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiSpellsGet(level?: Array<number>, school?: Array<string>, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<APIReferenceList> {
            const localVarFetchArgs = SpellsApiFetchParamCreator(configuration).apiSpellsGet(level, school, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiSpellsIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Spell> {
            const localVarFetchArgs = SpellsApiFetchParamCreator(configuration).apiSpellsIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const SpellsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * 
         * @summary Get list of spells with optional filtering.
...
export class SpellsApi extends BaseAPI {
    ...
    public apiSpellsGet(level?: Array<number>, school?: Array<string>, options?: any) {
        return SpellsApiFp(this.configuration).apiSpellsGet(level, school, options)(this.fetch, this.basePath);
    }
    ...
    public apiSpellsIndexGet(index: string, options?: any) {
        return SpellsApiFp(this.configuration).apiSpellsIndexGet(index, options)(this.fetch, this.basePath);
    }
...
export const SubclassesApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        apiSubclassesIndexFeaturesGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiSubclassesIndexFeaturesGet.');
            }
            const localVarPath = `/api/subclasses/{index}/features`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        apiSubclassesIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiSubclassesIndexGet.');
            }
            const localVarPath = `/api/subclasses/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        apiSubclassesIndexLevelsGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiSubclassesIndexLevelsGet.');
            }
            const localVarPath = `/api/subclasses/{index}/levels`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
         ...
         * @throws {RequiredError}
         */
        apiSubclassesIndexLevelsSubclassLevelFeaturesGet(index: string, subclassLevel: number, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiSubclassesIndexLevelsSubclassLevelFeaturesGet.');
            }
            // verify required parameter 'subclassLevel' is not null or undefined
            if (subclassLevel === null || subclassLevel === undefined) {
                throw new RequiredError('subclassLevel','Required parameter subclassLevel was null or undefined when calling apiSubclassesIndexLevelsSubclassLevelFeaturesGet.');
            }
         ...
         * @throws {RequiredError}
         */
        apiSubclassesIndexLevelsSubclassLevelGet(index: string, subclassLevel: number, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiSubclassesIndexLevelsSubclassLevelGet.');
            }
            // verify required parameter 'subclassLevel' is not null or undefined
            if (subclassLevel === null || subclassLevel === undefined) {
                throw new RequiredError('subclassLevel','Required parameter subclassLevel was null or undefined when calling apiSubclassesIndexLevelsSubclassLevelGet.');
            }
...
export const SubclassesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiSubclassesIndexFeaturesGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<APIReferenceList> {
            const localVarFetchArgs = SubclassesApiFetchParamCreator(configuration).apiSubclassesIndexFeaturesGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiSubclassesIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Subclass> {
            const localVarFetchArgs = SubclassesApiFetchParamCreator(configuration).apiSubclassesIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiSubclassesIndexLevelsGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<SubclassLevelResource>> {
            const localVarFetchArgs = SubclassesApiFetchParamCreator(configuration).apiSubclassesIndexLevelsGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiSubclassesIndexLevelsSubclassLevelFeaturesGet(index: string, subclassLevel: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<APIReferenceList> {
            const localVarFetchArgs = SubclassesApiFetchParamCreator(configuration).apiSubclassesIndexLevelsSubclassLevelFeaturesGet(index, subclassLevel, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiSubclassesIndexLevelsSubclassLevelGet(index: string, subclassLevel: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SubclassLevel> {
            const localVarFetchArgs = SubclassesApiFetchParamCreator(configuration).apiSubclassesIndexLevelsSubclassLevelGet(index, subclassLevel, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const SubclassesApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * 
         * @summary Get features available for a subclass.
        ...
        apiSubclassesIndexFeaturesGet(index: string, options?: any) {
            return SubclassesApiFp(configuration).apiSubclassesIndexFeaturesGet(index, options)(fetch, basePath);
        },
        /**
         * Subclasses reflect the different paths a class may take as levels are gained.
         * @summary Get a subclass by index.
        ...
        apiSubclassesIndexLevelsGet(index: string, options?: any) {
            return SubclassesApiFp(configuration).apiSubclassesIndexLevelsGet(index, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get features of the requested spell level available to the class.
         ...
         * @throws {RequiredError}
         */
        apiSubclassesIndexLevelsSubclassLevelFeaturesGet(index: string, subclassLevel: number, options?: any) {
            return SubclassesApiFp(configuration).apiSubclassesIndexLevelsSubclassLevelFeaturesGet(index, subclassLevel, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get level resources for a subclass and level.
        ...
        apiSubclassesIndexLevelsSubclassLevelGet(index: string, subclassLevel: number, options?: any) {
            return SubclassesApiFp(configuration).apiSubclassesIndexLevelsSubclassLevelGet(index, subclassLevel, options)(fetch, basePath);
        },
    };
};
...
export class SubclassesApi extends BaseAPI {
    ...
    public apiSubclassesIndexFeaturesGet(index: string, options?: any) {
        return SubclassesApiFp(this.configuration).apiSubclassesIndexFeaturesGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiSubclassesIndexGet(index: string, options?: any) {
        return SubclassesApiFp(this.configuration).apiSubclassesIndexGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiSubclassesIndexLevelsGet(index: string, options?: any) {
        return SubclassesApiFp(this.configuration).apiSubclassesIndexLevelsGet(index, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof SubclassesApi
     */
    public apiSubclassesIndexLevelsSubclassLevelFeaturesGet(index: string, subclassLevel: number, options?: any) {
        return SubclassesApiFp(this.configuration).apiSubclassesIndexLevelsSubclassLevelFeaturesGet(index, subclassLevel, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof SubclassesApi
     */
    public apiSubclassesIndexLevelsSubclassLevelGet(index: string, subclassLevel: number, options?: any) {
        return SubclassesApiFp(this.configuration).apiSubclassesIndexLevelsSubclassLevelGet(index, subclassLevel, options)(this.fetch, this.basePath);
    }
...
export const SubracesApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        apiSubracesIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiSubracesIndexGet.');
            }
            const localVarPath = `/api/subraces/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        apiSubracesIndexProficienciesGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiSubracesIndexProficienciesGet.');
            }
            const localVarPath = `/api/subraces/{index}/proficiencies`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        apiSubracesIndexTraitsGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiSubracesIndexTraitsGet.');
            }
            const localVarPath = `/api/subraces/{index}/traits`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
...
export const SubracesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiSubracesIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Subrace> {
            const localVarFetchArgs = SubracesApiFetchParamCreator(configuration).apiSubracesIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiSubracesIndexProficienciesGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<APIReferenceList> {
            const localVarFetchArgs = SubracesApiFetchParamCreator(configuration).apiSubracesIndexProficienciesGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        apiSubracesIndexTraitsGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<APIReferenceList> {
            const localVarFetchArgs = SubracesApiFetchParamCreator(configuration).apiSubracesIndexTraitsGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const SubracesApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * Subraces reflect the different varieties of a certain parent race.
         * @summary Get a subrace by index.
        ...
        apiSubracesIndexProficienciesGet(index: string, options?: any) {
            return SubracesApiFp(configuration).apiSubracesIndexProficienciesGet(index, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get traits available for a subrace.
        ...
        apiSubracesIndexTraitsGet(index: string, options?: any) {
            return SubracesApiFp(configuration).apiSubracesIndexTraitsGet(index, options)(fetch, basePath);
        },
    };
};
...
export class SubracesApi extends BaseAPI {
    ...
    public apiSubracesIndexGet(index: string, options?: any) {
        return SubracesApiFp(this.configuration).apiSubracesIndexGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiSubracesIndexProficienciesGet(index: string, options?: any) {
        return SubracesApiFp(this.configuration).apiSubracesIndexProficienciesGet(index, options)(this.fetch, this.basePath);
    }
    ...
    public apiSubracesIndexTraitsGet(index: string, options?: any) {
        return SubracesApiFp(this.configuration).apiSubracesIndexTraitsGet(index, options)(this.fetch, this.basePath);
    }
...
export const TraitsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        apiTraitsIndexGet(index: string, options: any = {}): FetchArgs {
            // verify required parameter 'index' is not null or undefined
            if (index === null || index === undefined) {
                throw new RequiredError('index','Required parameter index was null or undefined when calling apiTraitsIndexGet.');
            }
            const localVarPath = `/api/traits/{index}`
                .replace(`{${"index"}}`, encodeURIComponent(String(index)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
...
export const TraitsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiTraitsIndexGet(index: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Trait> {
            const localVarFetchArgs = TraitsApiFetchParamCreator(configuration).apiTraitsIndexGet(index, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const TraitsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * 
         * @summary Get a trait by index.
...
export class TraitsApi extends BaseAPI {
    ...
    public apiTraitsIndexGet(index: string, options?: any) {
        return TraitsApiFp(this.configuration).apiTraitsIndexGet(index, options)(this.fetch, this.basePath);
    }
